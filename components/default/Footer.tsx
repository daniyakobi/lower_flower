...
import footer_styles from '../../styles/components/Footer.module.scss'

const Footer = () => {
  return(
    <div className={ footer_styles.footer }>
      <div className={ `container ${ footer_styles.container }` }>
        <div className={ footer_styles.footer__block }>
          <Link href='/'>
            <a className={ footer_styles.footer__logo }>
        ...
        <div className={ footer_styles.footer__block }>
          <ul className={ footer_styles.footer__menu }>
            <li>
              <Link href='#'>
            ...
            <li>
              <Link href='#'>
                <a>для корпоративных клиентов</a>
              </Link>
            </li>
          </ul>
        </div>
        <div className={ footer_styles.footer__block }>
          <div className={ footer_styles.footer__contacts }>
            <div className={ footer_styles.footer__contacts_block }>
              <a href='mailto:zakaz@loverflower.by'>zakaz@loverflower.by</a>
              <p>Доставка 24/7 по договоренности с оператором</p>
            </div>
            <div className={ footer_styles.footer__contacts_block }>
              <Link href='/'>
                <a>ул. Тимирязева 67</a>
              </Link>
